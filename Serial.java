...
public class Serial{
  ...
  public Serial(List<String> mylist,String outfile,String[][] arr,int i,int j, int x_dimension, int y_dimension){
    this.mylist = mylist;
	...
	public void FindMin(int iq, int jq, int x_dimensionq, int y_dimensionq){
		int newi = iq;
		int xq = x_dimensionq;
		int yq = y_dimensionq;
    while(newi<xq){
  ...
  public static void main(String[] args){
    ...
    Serial st = new Serial(mylist,outfile,arr,1,1,newx,newy);
		tick();
		st.FindMin(1, 1, newx, newy);
		float time = tock();
